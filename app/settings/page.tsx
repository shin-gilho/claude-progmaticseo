            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="gemini-3-flash-preview">Gemini 3 Flash (프리뷰)</option>
                  <option value="gemini-3-pro-preview">Gemini 3 Pro (프리뷰)</option>
                </select>
              </div>
              <div>
